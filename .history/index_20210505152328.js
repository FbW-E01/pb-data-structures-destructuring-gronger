...
const arrayToDestructure = [ "banana", "cucumber", "bread", "cakes", "pizza" ];

const [ fruit ] = arrayToDestructure;
const [ , vegetable ] = arrayToDestructure;
const [ , , ...food ] = arrayToDestructure;
...
function printWholeObject(param) {
    return band.name + " was a " + band.genre + " " + band.nationality + " band whose lead singer was "
 + band.singer + ".";
}

console.log(printWholeObject(band));